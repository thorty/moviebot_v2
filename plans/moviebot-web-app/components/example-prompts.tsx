...
import { Clapperboard, Popcorn, Sparkles, Heart, Swords, Ghost } from "lucide-react"
...
const EXAMPLE_PROMPTS = [
  ...
  {
    icon: Heart,
    text: "Romantische Komödien wie bei Harry und Sally",
  },
  {
    icon: Swords,
    text: "Spannende Thriller mit unvorhersehbarem Ende",
  },
  {
    icon: Ghost,
    text: "Gruselige Horrorfilme für Halloween",
  },
  {
    icon: Clapperboard,
    text: "Oscar-prämierte Filme, die man gesehen haben muss",
  },
]
    ...
    <div className="flex flex-col items-center gap-8 py-8">
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <p className="max-w-md text-sm text-muted-foreground leading-relaxed">
          Beschreibe mir, wonach dir heute ist, und ich finde die perfekte
          Empfehlung für dich.
        </p>
      </div>
